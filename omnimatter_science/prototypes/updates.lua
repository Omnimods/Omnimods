...
if mods["omnimatter_crystal"] then
    ...
    if mods["Bio_Industries_2"] then
        omni.lib.replace_science_pack("bi-tech-advanced-biotechnology", "chemical-science-pack", "omni-pack")
        omni.lib.replace_science_pack("bi-tech-organic-plastic", "production-science-pack", "omni-pack")
    end
