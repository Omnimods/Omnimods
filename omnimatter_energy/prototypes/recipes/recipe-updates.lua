...
if not (mods["angelsindustries"] and angelsmods.industries.components) then
    ...
    omni.lib.replace_recipe_ingredient("burner-omnitractor", "omnium-gear-wheel", {"omnitor",2})
    omni.lib.replace_recipe_ingredient("burner-omniphlog", "omnium-gear-wheel", {"omnitor",5})
