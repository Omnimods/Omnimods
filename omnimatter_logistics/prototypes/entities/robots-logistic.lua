...
for i=1,nr_bots do
  ...
  --recipe
    ...
    idle = omni.logistics.cargo_bot_images.idle,
    idle_with_cargo = omni.logistics.cargo_bot_images.idle_with_cargo,
    in_motion = omni.logistics.cargo_bot_images.in_motion,
    in_motion_with_cargo = omni.logistics.cargo_bot_images.in_motion_with_cargo,
    shadow_idle = omni.logistics.cargo_bot_images.shadow_idle,
    shadow_idle_with_cargo = omni.logistics.cargo_bot_images.shadow_idle_with_cargo,
    shadow_in_motion = omni.logistics.cargo_bot_images.shadow_in_motion,
    shadow_in_motion_with_cargo = omni.logistics.cargo_bot_images.shadow_in_motion_with_cargo,
