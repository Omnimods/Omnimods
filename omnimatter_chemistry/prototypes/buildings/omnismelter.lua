...
local get_cost = function(tier)
    ...
    if tier > 1 then
        ing[#ing+1]={type="item",name="omnismelter-"..tier-1,amount=1}
    end
    return ing
end
for i=1, 4 do
    ...
    name = "omnismelter-"..i,
    icons = {
        {icon="__omnimatter_chemistry__/graphics/icons/omnismelter.png",},
        {icon = "__omnimatter__/graphics/icons/extraction-"..i..".png"},
        },
    flags = {"placeable-neutral","player-creation"},
    minable = {mining_time = 1, result = "omnismelter-"..i},
    fast_replaceable_group = "omnismelter",
    max_health = 300,
    icon_size = 32,
    corpse = "big-remnants",
    ...
    crafting_categories = {"omnifurnace"},
    ...
    local r = {}
    if i==1 then
        r={"omni-sorting-electric-1","angels-iron-smelting-1","angels-copper-smelting-1"}
    else
        r={"omnismelter-"..i-1,"omni-sorting-electric-"..i}
    end
    reg[#reg+1]={
    type = "technology",
    name = "omnismelter-"..i,
    icon = "__omnimatter_chemistry__/graphics/technology/omnismelter.png",
    icon_size = 128,
    order = "z",
    effects = {
        {type = "unlock-recipe",
        recipe="omnismelter-"..i},
    },
    upgrade = i>1,
    prerequisites = r,
    unit =
