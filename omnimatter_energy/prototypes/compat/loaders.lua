...
if data.raw.recipe["chute-mdrn-loader"] then
    ...
    if data.raw.recipe["bob-basic-underground-belt"] then
        omni.lib.replace_recipe_ingredient("basic-mdrn-loader", "bob-basic-underground-belt", "basic-underground-belt")
    end
end
...
if data.raw.recipe["chute-mdrn-loader"] then
    ...
    if data.raw.recipe["bob-basic-underground-belt"] then
        omni.lib.replace_recipe_ingredient("hps__ml-bob-basic-miniloader", "bob-basic-underground-belt",
