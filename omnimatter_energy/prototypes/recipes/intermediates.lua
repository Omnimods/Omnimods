RecGen:create("omnimatter_energy","omnitor"):
    ...
    setOrder("a"):
    setEnergy(0.75):
    setIngredients({type="item", name="omnium-plate", amount=1},{type="item", name="omnium-gear-wheel", amount=1}):
    addProductivity():
    setEnabled():
    extend()

RecGen:create("omnimatter_energy","anbaric-omnitor"):
    setIngredients({type="item", name="omnium-plate", amount=2},{type="item", name="copper-cable", amount=2},{type="item", name="omnitor", amount=1}):
    addProductivity():
    setStacksize(100):
